		...
		<!-- Brand and toggle get grouped for better mobile display -->
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<h1 id="logo"><a href="index.php">CED-H<img src="img.png" style="width:50px;height:50px;vertical-align: top;">STING</a></h1>
						</div>
					</div>
		...
		<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li class="<?php if($menu =="home"){echo "active";}?>"><a href="index.php">Home <i class="sr-only">(current)</i></a></li>
							...
							<li><a href="contact.php"><i class="fa fa-shopping-cart" style="font-size:24px"aria-hidden="true"></i>
							</a></li>
